...
var WebinarForm = []Question{
	{ID: "webinar info",
		Text: "❤️ <b>Открытая встреча</b>\n" +
			...
			"Разберём:\n\n" +
			"- почему раньше могли приходить “не те” мужчины;\n" +
			"- как анкета и фото влияют на уровень знакомств;\n" +
			"- что смотреть в первых сообщениях;\n" +
			"- как понять, стоит ли идти на свидание;\n" +
			"- почему успешный мужчина ещё не значит ваш;\n" +
			"- как выбрать своего среди достойных.\n\n" +
			"В конце расскажу про программу <b>«Путь к своему мужчине»</b>, старт 19 мая.\n\n" +
			"Нажмите кнопку ниже, чтобы зарегистрироваться.",
		Options:  []string{"Зарегистрироваться на встречу", BtnToMainMenu},
		Type:     InputChoice,
		InfoOnly: true,
	},
}
